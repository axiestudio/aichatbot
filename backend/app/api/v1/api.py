...
from app.api.v1.endpoints.enterprise_monitoring import router as enterprise_monitoring_router
...
api_router.include_router(enterprise_monitoring_router, prefix="/enterprise", tags=["enterprise-monitoring"])
